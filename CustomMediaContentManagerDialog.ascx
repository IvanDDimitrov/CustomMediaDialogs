...
<div class="sfBasicDim">
    <div runat="server" id="mediaContentManagerWrapper" class="sfContentViews">
         <%--<sf:SingleMediaContentItemView id="contentSelectorView" runat="server" UseSmallItemPreview="true" SkipBlankItemView="true" ShowCropResizeRotateButton="true"></sf:SingleMediaContentItemView>--%>
          ...
          <test:CustomSingleMediaContentItemView id="contentSelectorView" runat="server" UseSmallItemPreview="true" SkipBlankItemView="true" ShowCropResizeRotateButton="true"></test:CustomSingleMediaContentItemView>
        ...
        <sf:SingleMediaContentItemView id="itemSettingsView" ShowAlignmentOptions="true" runat="server"></sf:SingleMediaContentItemView>
